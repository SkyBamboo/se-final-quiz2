...
public class BITree<D extends BITree.Data> {

    private Object[] array;

    public BITree(List<D> data) {
        int n = 0;
        for (Data d : data)
            if (d.index > n)
                n = d.index;
    ...
    public String toString() {
        ...
        builder.append(BinaryIndexedTreePrinter.getString(this));
        return builder.toString();
    }

    protected static class BinaryIndexedTreePrinter {

        public static <D extends BITree.Data> String getString(BITree<D> tree) {
        ...
        private static <D extends BITree.Data> String getString(BITree<D> tree, int start, int end, String prefix, boolean isTail) {
